...
class phc_ACPPlus_Helper_IpInRange
{
    /*
    ...
    */
    ...
    public function ipv4_in_range($ip, $range)
    {
        ...
        else
        {
            ...
            {   // a.b.*.* format
                ...
                $ipPieces = @explode('.', $range);
                $ip_p1 = (isset($ipPieces[0]) ? $ipPieces[0] : '*');
                $ip_p2 = (isset($ipPieces[1]) ? $ipPieces[1] : '*');
                $ip_p3 = (isset($ipPieces[2]) ? $ipPieces[2] : '*');
                $ip_p4 = (isset($ipPieces[3]) ? $ipPieces[3] : '*');

                $range = "$ip_p1.$ip_p2.$ip_p3.$ip_p4";
    ...
    public function checkIfIpInRange($ip, $range, $type)
    {
        if($type == phc_ACPPlus_Helper_Security::IP_TYPE_V4)
        {
            return $this->ipv4_in_range($ip, $range);
        }
        elseif($type == phc_ACPPlus_Helper_Security::IP_TYPE_V6)
        {
    ...
    public function checkIfIPAllowed($ip, $allowdIP)
    {
        if(strtolower($ip) == strtolower($allowdIP))
        {
            return true;
        }
