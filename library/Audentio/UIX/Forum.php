...
class Audentio_UIX_ControllerPublic_Forum extends XFCP_Audentio_UIX_ControllerPublic_Forum
{
	...
	public function actionForum()
	{
		...
		if ($response instanceof XenForo_ControllerResponse_View) {
			...
			var_dump(array_key_exists('uix_collapse_stuck_threads', $visitor));die;
			if (array_key_exists('uix_collapse_stuck_threads', $visitor)) {
				die('test');
		...
		var_dump($collapseStuckThreads, $visitor['uix_collapse_stuck_threads'], $forum['uix_last_sticky_action']);
