...
class Audentio_UIX_DataWriter_NodeFields extends XenForo_DataWriter
{
    protected function _getFields()
    {
        ...
        $fields['uix_node_fields']['inheritStyling'] = array('type' => self::TYPE_BOOLEAN, 'default' => 0);
    ...
    protected function _postSave()
    {
        ...
        if ($this->isInsert() || $this->isChanged('uix_styling') || $this->isChanged('inheritClass') || $this->isChanged('inheritStyling')) {
