...
class Siropu_Chat_Route_Prefix_Extend_SpamCleaner implements XenForo_Route_Interface
{
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		return $router->getRouteMatch('Siropu_Chat_ControllerPublic_Extend_SpamCleaner', $routePath, 'spam-cleaner');
	}
}