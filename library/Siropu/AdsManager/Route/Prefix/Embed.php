...
class Siropu_AdsManager_Route_Prefix_Embed implements XenForo_Route_Interface
{
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		return $router->getRouteMatch('Siropu_AdsManager_ControllerPublic_Embed', $routePath, 'sam-embed');
	}
}