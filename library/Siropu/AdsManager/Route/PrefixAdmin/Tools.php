...
class Siropu_AdsManager_Route_PrefixAdmin_Tools implements XenForo_Route_Interface
{
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		return $router->getRouteMatch('Siropu_AdsManager_ControllerAdmin_Tools', $routePath, 'siropu_ads_manager_tools');
	}
}