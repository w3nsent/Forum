...
class Siropu_AdsManager_Route_PrefixAdmin_Subscriptions implements XenForo_Route_Interface
{
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		$action = $router->resolveActionWithIntegerParam($routePath, $request, 'subscription_id');
		return $router->getRouteMatch('Siropu_AdsManager_ControllerAdmin_Subscriptions', $action, 'siropu_ads_manager_subl');
	}
