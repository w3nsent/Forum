...
class Siropu_AdsManager_Route_PrefixAdmin_Ads implements XenForo_Route_Interface
{
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		$action = $router->resolveActionWithIntegerParam($routePath, $request, 'ad_id');
		return $router->getRouteMatch('Siropu_AdsManager_ControllerAdmin_Ads', $action, 'siropu_ads_manager_ads');
	}
