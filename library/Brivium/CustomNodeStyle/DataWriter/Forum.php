...
class Brivium_CustomNodeStyle_DataWriter_Forum extends XFCP_Brivium_CustomNodeStyle_DataWriter_Forum
{
	...
	public function save()
	{
		if(!empty($GLOBALS['BRCNS_ControllerAdmin_Node'])){
			...
			$params = $this->_getNodeModel()->writeNodeExtraData($this, $controller);
